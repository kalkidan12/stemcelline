	...
	return (
      ...
      "
									...
									<div className="form-group form-check text-center mb-6">
										<input
											type="checkbox"
											className="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-lime-600 checked:border-lime-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
											id="exampleCheck87"
										/>
								...
								<div className="flex flex-wrap">
									<div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
										<div className="flex items-start">
											<div className="shrink-0">
												<div className="p-4 bg-lime-500 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
													<svg
														aria-hidden="true"
														focusable="false"
														data-prefix="fas"
											...
											<div className="grow ml-6">
												<p className="font-bold mb-1 text-lime-500">
													Technical support
												</p>
												<p className="text-gray-500">Query@stemcelline.com</p>
									...
									<div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
										<div className="flex items-start">
											...
											<div className="grow ml-6">
												...
												<p className="text-gray-500">Query@stemcelline.com</p>
												<p className="text-gray-500">+91 73030 18489</p>
											</div>
										</div>
									</div>
									<div className="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
										<div className="flex align-start">
											...
											<div className="grow ml-6">
												<p className="font-bold mb-1 text-lime-500">Press</p>
												<p className="text-gray-500">Query@stemcelline.com</p>
												<p className="text-gray-500">+91 73030 18489</p>
											</div>
										</div>
									...
									<div className="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
										<div className="flex align-start">
											...
											<div className="grow ml-6">
												<p className="font-bold text-lime-500 mb-1">
													Problem report
												</p>
												<p className="text-gray-500">Query@stemcelline.com</p>
												<p className="text-gray-500">+91 73030 18489</p>
